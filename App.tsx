    ...
    <div className="min-h-screen bg-white text-black selection:bg-[#008b8b] selection:text-white">
      ...
      <div className="relative z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            {rates && (
              <div className="text-right hidden sm:block border-r border-gray-800 pr-6">
                ...
                <div className="text-[#008b8b] font-black text-xl font-mono">${rates.base.toFixed(2)}/hr</div>
              </div>
            )}
            {user && (
              <div className="text-right hidden sm:block border-r border-gray-800 pr-6">
        ...
        <main className="container mx-auto px-3 md:px-6 py-6 md:py-16">
          ...
          {draftPrompt && (
            <div className="mb-8 max-w-3xl mx-auto bg-[#008b8b]/10 border border-[#008b8b]/40 rounded-sm p-4 flex items-center justify-between gap-4 print:hidden">
              <div className="flex items-center gap-3">
                <svg className="w-6 h-6 text-[#008b8b] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="bg-[#008b8b] hover:bg-[#20b2aa] text-black px-4 py-2 text-xs font-black uppercase tracking-widest transition-all"
                >
                  Restore
                </button>
                <button
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden print:hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-[#008b8b]/5 blur-[160px] rounded-full animate-pulse"></div>
